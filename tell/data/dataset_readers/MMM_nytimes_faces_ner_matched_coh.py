...
@DatasetReader.register('MMM_nytimes_faces_ner_matched_coh')
class MMMNYTimesFacesNERMatchedReader2_Coh(DatasetReader): 
            ...
            for pos in image_positions:
                ...
                if split == "test" and os.path.exists(self.gen_path):
                    ...
                    if hash in self.gen_captions:
                        ...
                        continue
                    #caption = self.gen_captions[sections[pos]['hash']] 
                ...
                yield self.article_to_instance(
                    ...
                    article['web_url'], pos, face_embeds, obj_feats, article_id)
