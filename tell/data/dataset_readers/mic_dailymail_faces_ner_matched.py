...
@DatasetReader.register('mic_dailymail_faces_ner_matched')
class MICDailyMailFacesNERMatchedReader(DatasetReader):
        ...
        for article_id in ids:
            ...
            for pos in image_positions:
                ...
                yield self.article_to_instance(
                    paragraphs, named_entities, image, caption, fake_captions, image_path,
                    "" if 'web_url' not in article else article['web_url'], pos, face_embeds, obj_feats)

    def article_to_instance(self, paragraphs, named_entities, image, caption, fake_captions, 
