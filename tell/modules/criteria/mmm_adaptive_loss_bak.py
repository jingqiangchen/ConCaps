...
class MMMAdaptiveLoss(Criterion):
    ...
    def __init__(self, padding_idx=1, input_dim = 1024, method = "softmax", lambda1=None, lambda2=None, lambda3=None):
        super().__init__()
    ...
    def forward_sigmoid(self, adaptive_softmax, net_output, decoder_target, caption_ids, fake_captions_ids, article_indices, reduction='sum'):
        ...
        return loss, sample_size, fake_loss, fake_size, coh_loss, coh_size, mm_loss, mm_size
