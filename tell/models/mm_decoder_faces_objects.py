...
@Decoder.register('mm_dynamic_conv_decoder_faces_objects')
class MMDynamicConvFacesObjectsDecoder(Decoder):
    def __init__(self, vocab, embedder: TextFieldEmbedder, max_target_positions, dropout,
        ...
        self.layers.extend([
            MMDynamicConvDecoderLayer(embed_dim, decoder_conv_dim, decoder_glu,
                                    decoder_conv_type, weight_softmax, decoder_attention_heads,
...
@DecoderLayer.register('mm_dynamic_conv_faces_objects')
class MMDynamicConvDecoderLayer(DecoderLayer):
