...
@Decoder.register('mic_dynamic_conv_decoder_faces_objects')
class MICDynamicConvFacesObjectsDecoder(Decoder):
    def __init__(self, vocab, embedder: TextFieldEmbedder, max_target_positions, dropout,
        ...
        self.layers.extend([
            MICDynamicConvDecoderLayer(embed_dim, decoder_conv_dim, decoder_glu,
                                    decoder_conv_type, weight_softmax, decoder_attention_heads,
    ...
    def forward(self, prev_target, fake_captions, contexts, incremental_state=None,
...
@DecoderLayer.register('mic_dynamic_conv_faces_objects')
class MICDynamicConvDecoderLayer(DecoderLayer):
