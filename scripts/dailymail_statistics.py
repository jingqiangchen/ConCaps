...
class DailyMailStatistics:
    ...
    def compute(self, split: str):
        ...
        pre_out = open("dailymail_pre_out.txt", "w")
        pre_out2 = open("dailymail_pre_out2.txt", "w")
        pre_out3 = open("dailymail_pre_out3.txt", "w")
        pre_out4 = open("dailymail_pre_out4.txt", "w")
        pre_out5 = open("dailymail_pre_out5.txt", "w")
    ...
    def compute1(self):
        pre_out = np.loadtxt("dailymail_new_pre_out.txt", delimiter="\t")
        pre_out2 = np.loadtxt("dailymail_new_pre_out2.txt", delimiter="\t")
        pre_out3 = np.loadtxt("dailymail_new_pre_out3.txt", delimiter="\t")
        pre_out4 = np.loadtxt("dailymail_new_pre_out4.txt", delimiter="\t")
        pre_out5 = np.loadtxt("dailymail_new_pre_out5.txt", delimiter="\t")
        ...
        with open("dailymail_compute1.txt", "w") as f:
    ...
    def compute3(self):
        out_file = open("dailymail_compute3.txt", "w")
        sys.stdout = out_file
    ...
    def compute4(self):
        pre_out = np.loadtxt("/home/test/mic/codes/transfrom-and-tell-1120/dailymail_pre_out.txt", delimiter="\t")
        a1 = np.mean(pre_out[:, :2], axis=1)
    ...
    def compute_for_generations(self, gen_path, out_path):
        ...
        logger.info('Grabbing all article IDs')
        sample_cursor = self.db.articles.find({
            'split': "test", 'n_images': {"$lte": 10, "$gte": 1}
        }, projection=['_id']).sort('_id', pymongo.ASCENDING)
        ids = np.array([article['_id'] for article in tqdm(sample_cursor)])
        ids = ids[:len(ids)//2]
        sample_cursor.close()
...
def postprocess():
    pre_in = open("dailymail_pre_out.txt")
    pre_out = open("dailymail_new_pre_out.txt", "w")
    ...
    i = 0
    pre_in = open("dailymail_pre_out2.txt")
    pre_out = open("dailymail_new_pre_out2.txt", "w")
    for line in pre_in.readlines():
        line = line.strip()
        if line != "":
            if i % 2 == 1:
    ...
    pre_in = open("dailymail_pre_out3.txt")
    pre_out = open("dailymail_new_pre_out3.txt", "w")
    for line in pre_in.readlines():
        line = line.strip()
        if line != "":
            pre_out.write(line + "\n")
    ...
    pre_in = open("dailymail_pre_out4.txt")
    pre_out = open("dailymail_new_pre_out4.txt", "w")
    for line in pre_in.readlines():
        line = line.strip()
        if line != "":
            pre_out.write(line + "\n")
    ...
    pre_in = open("dailymail_pre_out5.txt")
    pre_out = open("dailymail_new_pre_out5.txt", "w")
    for line in pre_in.readlines():
        line = line.strip()
        if line != "":
            pre_out.write(line + "\n")
...
if __name__ == '__main__':
    #DailyMailStatistics().compute("train")
    #postprocess()
    #DailyMailStatistics().compute1()
    #DailyMailStatistics().compute3()
    #DailyMailStatistics().compute_for_generations("/home/test/mic/codes/transform-and-tell-1120/expt/dailymail/MMM_fc2_v2_new/serialization/generations0.jsonl", "DM_MMM_fc2_v2_new.txt")
    #DailyMailStatistics().compute1_generation("DM_MMM_fc2_v2_new.txt", "DM_MMM_fc2_v2_new_out.txt")
    #DailyMailStatistics().compute_for_generations("/home/test/mic/codes/transform-and-tell-1120/expt/dailymail/MMM_fd1_v2_new/serialization/generations0.jsonl", "DM_MMM_fd1_v2_new.txt")
    #DailyMailStatistics().compute1_generation("DM_MMM_fd1_v2_new.txt", "DM_MMM_fd1_v2_new_out.txt")
    #DailyMailStatistics().compute_for_generations("/home/test/mic/codes/transform-and-tell-1120/expt/dailymail/MMM_fcd1/serialization/generations0.jsonl", "DM_MMM_fcd1.txt")
    #DailyMailStatistics().compute1_generation("DM_MMM_fcd1.txt", "DM_MMM_fcd1_out.txt")
    #DailyMailStatistics().compute_for_generations("/home/test/mic/codes/transform-and-tell-1120/expt/dailymail/9_transformer_objects/serialization/generations0.jsonl", "9_transformer_objects.txt")
    #DailyMailStatistics().compute1_generation("9_transformer_objects.txt", "9_transformer_objects_out.txt")
    #DailyMailStatistics().compute_for_generations("/home/test/mic/codes/transform-and-tell-1120/expt/dailymail/MMM_fcd1_v2/serialization/generations0.jsonl", "MMM_fcd1_v2.txt")
    #DailyMailStatistics().compute1_generation("MMM_fcd1.txt", "MMM_fcd1_v2_out.txt")
    #DailyMailStatistics().compute_for_generations("/home/test/mic/codes/transform-and-tell-1120/expt/dailymail/MMM_f1_v2/serialization/generations.jsonl", "MMM_f1_v2.txt")
    #DailyMailStatistics().compute1_generation("MMM_f1_v2.txt", "MMM_f1_v2_out.txt")
    #DailyMailStatistics().compute_for_generations("/home/test/mic/codes/show-attend-tell/dailymail/generations.json", "show-attend-tell.txt")
    DailyMailStatistics().compute1_generation("show-attend-tell.txt", "show-attend-tell_out.txt")
    #DailyMailStatistics().compute_for_got("dailymail_got.txt")
    #DailyMailStatistics().compute1_generation("dailymail_got.txt", "dailymail_got_out.txt")
